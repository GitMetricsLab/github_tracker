const About = () => {
  return (
    <div className="about-container">
      {/* Hero Section */}
     <section className="hero bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 py-12">
      ...
      {/* Mission Section */}
      <section className="mission py-12 text-gray-800 dark:text-gray-100">
      ...
      {/* Features Section */}
      <section className="features bg-gray-100 dark:bg-gray-800 py-12 text-gray-800 dark:text-gray-100">
